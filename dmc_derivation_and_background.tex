...
The details of this are beyond the scope of this paper, however the result is a Gaussian function of width $\sqrt{\frac{\Delta\tau}{m}}$. The operation of the potential energy follows suit:
